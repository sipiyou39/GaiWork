...
export const COMPANION_SET_INTERACTIVE_CHANNEL = "desktop:companion-set-interactive";
export const COMPANION_POINTER_EVENT_CHANNEL = "desktop:companion-pointer-event";
export const COMPANION_OPEN_COMPOSER_CHANNEL = "desktop:companions-open-composer";
export const COMPANION_PORTAL_LAYOUT_CHANNEL = "desktop:companions-portal-layout";
export const COMPANION_CLOSE_COMPOSER_CHANNEL = "desktop:companions-close-composer";
export const COMPANION_PORTAL_READY_CHANNEL = "desktop:companions-portal-ready";
