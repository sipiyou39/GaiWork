    ...
    Layer.provideMerge(
      Layer.mergeAll(
        ...
        Layer.succeed(DesktopWindow.DesktopWindow, {
          ...
          navigateToThread: () => Effect.die("unexpected thread navigation"),
          openCompanionConversation: () => Effect.die("unexpected companion navigation"),
          showWorkspace: Effect.die("unexpected workspace reveal"),
          showConversationFocus: Effect.die("unexpected conversation focus reveal"),
          getPresentation: Effect.succeed({ mode: "workspace", transitionId: 0 }),
          requestPresentation: () => Effect.die("unexpected presentation request"),
