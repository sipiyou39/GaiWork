...
const CONNECTIONS_KEY = "doudou-code.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "doudou-code.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "doudou-code.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "doudou-code.recent-thread-shortcuts";
